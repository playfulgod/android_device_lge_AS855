...
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/lge/AS855/kernel
else
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.AS855.rc:root/init.rc \
    $(LOCAL_PATH)/ueventd.AS855.rc:root/ueventd.lge.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/chargemode/chargerimages/battery_charging_trickle.rle:root/chargerimages/battery_charging_trickle.rle \
    ...
    $(LOCAL_PATH)/chargemode/chargerimages/logo_480x800.rle:root/chargerimages/logo_480x800.rle \
